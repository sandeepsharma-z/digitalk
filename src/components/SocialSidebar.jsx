...
const socials = [
  {
    label: 'LinkedIn',
    color: '#0077b5',
    href: 'https://www.linkedin.com/company/digitalk-digitalmarketing/',
    icon: (
  ...
  },
  {
    label: 'Instagram',
    color: '#e1306c',
    href: 'https://www.instagram.com/digi_talk._',
    icon: (
  ...
  },
  {
    label: 'Facebook',
    color: '#1877f2',
    href: 'https://www.facebook.com/share/1G9eoTYhc6/',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    label: 'YouTube',
    color: '#ff0000',
    href: 'https://www.youtube.com/@DigiTalk-108',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
