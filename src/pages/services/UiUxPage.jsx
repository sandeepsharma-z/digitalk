...
const features = [
  {
    title: 'User Research',
    desc: 'Interviews, surveys, and behavioural analysis that surface what your users actually need — not just what they say they want.',
    icon: (
  ...
  {
    title: 'Wireframing',
    desc: 'Lo-fi and hi-fi wireframes that map every screen and flow, validated with stakeholders before any visual design begins.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7">
  ...
  {
    title: 'Prototyping',
    desc: 'Fully interactive Figma prototypes that feel like the real product — perfect for user testing and stakeholder sign-off.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7">
  ...
  },
  {
    ...
    desc: 'Scalable component libraries and style guides that keep your product visually consistent as it grows.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7">
  ...
  },
  {
    ...
    desc: 'Moderated and unmoderated tests with real users that pinpoint friction and validate design decisions with evidence.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7">
  ...
  },
  {
    ...
    desc: 'Annotated Figma files, token exports, and developer walkthroughs that eliminate guesswork during implementation.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7">
...
const steps = [
  { num: '01', title: 'Research', desc: 'We interview users, analyse competitors, and map existing flows to understand the full design problem.' },
  { num: '02', title: 'Wireframe', desc: 'Structural blueprints are created for every screen, reviewed collaboratively until the architecture is perfect.' },
  { num: '03', title: 'Prototype', desc: 'High-fidelity interactive prototypes are built and tested with real users to validate every design decision.' },
  { num: '04', title: 'Deliver', desc: 'Production-ready design files and a component library are handed off with thorough developer documentation.' },
]

const stats = [
  { val: '200+', label: 'Interfaces Designed', icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8">
      <rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/>
    </svg>
  )},
  { val: '89%', label: 'Avg Usability Score', icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8">
      <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/>
    </svg>
  )},
  { val: '3x', label: 'Avg Engagement Lift', icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8">
      <polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/>
    </svg>
  )},
  { val: '2wk', label: 'First Prototype', icon: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8">
    ...
    <div>
      ...
      <section className="relative min-h-[520px] flex items-center overflow-hidden">
        <div
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1561070791-2526d30994b5?w=1920&q=85&fit=crop')" }}
        />
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-6 py-24">
          ...
          >
            <span className="section-badge mb-5 inline-block">UI/UX Design</span>
            <h1 className="text-5xl md:text-6xl font-extrabold text-white leading-tight mb-5">
              UI/UX Design{' '}
              <span className="gradient-text-light block mt-1">Interfaces That Convert</span>
            </h1>
            <p className="text-slate-300 text-lg mb-8 leading-relaxed">
              We design digital products that users genuinely enjoy — grounded in research, validated by testing, and built to drive measurable business outcomes.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <a href="/contact" className="btn-primary">Design Your Product</a>
              <a href="/portfolio" className="btn-white">View Design Work</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#f8faff]">
        <div className="max-w-[1440px] mx-auto px-6">
          ...
          >
            <span className="section-badge-light mb-4 inline-block">What We Offer</span>
            <h2 className="text-4xl font-bold gradient-text">Human-Centred Design Services</h2>
            <p className="text-gray-500 mt-3 max-w-xl mx-auto">Every deliverable is rooted in user insight and designed to create experiences that feel effortless and look exceptional.</p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1440px] mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl font-bold gradient-text">Design Done Right</h2>
            <p className="text-gray-500 mt-3 max-w-xl mx-auto">A rigorous, collaborative design process that produces beautiful interfaces backed by evidence — not guesswork.</p>
          </div>
      ...
      <section className="py-20 bg-[#f8faff] text-center">
        ...
        >
          <span className="section-badge-light mb-4 inline-block">Let's Create Together</span>
          <h2 className="text-4xl font-bold gradient-text mb-4">Design Your Product</h2>
          <p className="text-gray-500 max-w-lg mx-auto mb-8">Let's turn your product vision into an interface users will love — get in touch for a free design consultation.</p>
          <a href="/contact" className="btn-primary">Get a Free Design Consultation</a>
        </div>
      </section>
    </div>
  )
